...
class FlightSimulator(ShowBase):
    ...
    def login_menu(self):
        ...
        self.titleLoginBackdrop = DirectFrame(frameColor = (255, 255, 255, 1),
                                            frameSize = (-1, 1, -1, 1),
        ...
        title = DirectLabel(text = "Welcome to Flight-IL!",
                            ...
                            text_font = self.font)
        title2 = DirectLabel(text = 'To log-in, fill in the details and press "Login"',
                            scale = 0.07,
                            pos = (0, 0, 0.6),
                            relief = None,
                            parent = self.titleLogin,
        ...
        login_btn = DirectButton(text = "Login",
                        command = self.select_plane_menu,
                        pos = (0, 0, -0.7),
                        parent = self.titleLogin,
                        scale = 0.3,
                        text_font = self.font)
        login_btn.setTransparency(True)

        forgot_password_btn = DirectButton(text = "I forgot my password",
                        command = self.sign_up_menu,
                        pos = (0, 0, -0.9),
                        parent = self.titleLogin,
                        scale = 0.05,
                        text_font = self.font)
        forgot_password_btn.setTransparency(True)
    ...
    def sign_up_menu(self):
        ...
        # Note the parent
        self.titleSignUpBackdrop = DirectFrame(frameColor = (255, 255, 255, 1),
                                            frameSize = (-1, 1, -1, 1),
                                            parent = self.render2d)
        ...
        title = DirectLabel(text = "Welcome to Flight-IL!",
                            ...
                            text_font = self.font)
        title2 = DirectLabel(text = 'To sign-up, fill in the details and press "Sign Up"',
                            scale = 0.07,
                            pos = (0, 0, 0.6),
                            relief = None,
                            parent = self.titleSignUp,
        ...
        signup_btn = DirectButton(text = "Sign Up",
                        command = self.select_plane_menu,
                        pos = (0, 0, -0.7),
                        parent = self.titleSignUp,
                        scale = 0.3,
                        text_font = self.font)
        signup_btn.setTransparency(True)
    ...
    def setup(self):
        ...
        # Load the aircraft
        self.aircraft = loader.loadModel(f'models/{AIRCRAFT}.gltf')
